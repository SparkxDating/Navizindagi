        ...
        <div>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-cream/70">{tValue({ en: displayTagline(settings?.tagline), hi: settings?.taglineHi })}</p>
            </div>
          </div>
          <p className="mt-4 max-w-sm text-sm leading-relaxed text-cream/70">
            {tValue({ en: settings?.mission, hi: settings?.missionHi }) || t("footer.fallbackMission")}
          </p>
